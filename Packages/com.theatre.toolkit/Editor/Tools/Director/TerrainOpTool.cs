...
namespace Theatre.Editor.Tools.Director
{
    ...
    public static class TerrainOpTool
    {
        ...
        private static string Execute(JToken arguments) =>
            CompoundToolDispatcher.Execute(
                ...
                (args, operation) => operation switch
                {
                    ...
                    "smooth_heightmap"  => SmoothHeightmap(args),
                    "paint_texture"     => PaintTexture(args),
                    "add_terrain_layer" => AddTerrainLayer(args),
                    "place_trees"       => PlaceTrees(args),
                    "place_details"     => PlaceDetails(args),
        ...
        /// </summary>
        private static Terrain ResolveTerrain(string terrainPath, out string error)
        {
            error = null;
