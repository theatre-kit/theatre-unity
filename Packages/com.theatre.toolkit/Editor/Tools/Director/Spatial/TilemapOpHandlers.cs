...
{
    /// <summary>
    /// Handlers for all tilemap_op operations.
    /// Each method is internal and called by TilemapOpTool's dispatcher.
    /// </summary>
    internal static class TilemapOpHandlers
    {
        ...
        /// </summary>
        internal static Tilemap ResolveTilemap(string tilemapPath, out string error)
        {
            error = null;
        ...
        /// </summary>
        internal static Vector3Int ParseCellPosition(JArray arr, out string posError)
        {
            posError = null;
